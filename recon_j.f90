Subroutine recon_j(j_corr,ham,crys,blop,psi,psj,nwfn)
                    ...
                    Do j=1,blop%numl(l,k)
                       ...
                       Do m=-l,+l
                          Do mp=-l,+l
                             ...
                             indxi =table(nw,npi,m,k,kk)
                             indxj =table(nw,npj,m,k,kk)
                             indxjp=table(nw,npj,m+1,k,kk)
                             indxjm=table(nw,npj,m-1,k,kk)
...
!                                     blop%deltaj(l,i,j,k)*fac*&
 ...
 !                                    blop%deltaj(l,i,j,k)*fac*&
                                     dci*Conjg(worki(indxi))*workj(indxjm)
                             End If
                             ...
                             If(m.Eq.mp-1) Then
                                ...
                                j_corr(k,kk,2)=j_corr(k,kk,2)-&
!                                     blop%deltaj(l,i,j,k)*fac*&
                                     dci*Conjg(worki(indxi))*workj(indxjp)
                             End If
