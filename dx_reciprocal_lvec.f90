...
!     @process extchk
!
subroutine dx_reciprocal_lvec(crys, myproc)
  ...
  !
  !     ------------------------------------------------------------------
  !     writes the file RECIP_VEC.dx for the IBM data explorer,
  !     a visualization software package.
  !
  !
  !     originally 1996 Bernd Pfrommer
  !     modified 2001 David Roundy to do reciprocal lattice vectors.
  !
  !     added the RCELL_FRAME.dx file
  !
  !
  !     INPUT
  !     -----
  ...
  open(19, file = 'vis/RECIP_VEC.dx', status = 'unknown', &
       form = 'formatted')
  write(19, 10)  
  write(19, 20) 1, 3  
  write(19, 30) ((crys%bvec(i, j), i = 1, 3), j = 1, 3)  
  write(19, 20) 2, 3  
  write(19, 35)  
  write(19, 40) 3, 1, 2  
  write(19, 50)  
  ...
  open(19, file = 'vis/RCELL_FRAME.dx', status = 'unknown', &
       form = 'formatted')
  write(19, 60)  
  write(19, 15) 3, 12  
  ...
  write(19, 30) (crys%bvec(i, 1), i = 1, 3)  
  write(19, 30) (crys%bvec(i, 2), i = 1, 3)  
  write(19, 30) (crys%bvec(i, 3), i = 1, 3)  
  write(19, 30) (crys%bvec(i, 1) + crys%bvec(i, 2), i = 1, 3)  
  write(19, 30) (crys%bvec(i, 1) + crys%bvec(i, 3), i = 1, 3)  
  write(19, 30) (crys%bvec(i, 2) + crys%bvec(i, 3), i = 1, 3)  
  write(19, 30) (crys%bvec(i, 1) + crys%bvec(i, 2) + crys%bvec(i, 3), i = 1, 3)
  write(19, 70) 5, 12  
  write(19, '(12(''1.0''/))')  
...
10 format(2('#',/),'#    RECIPROCAL VECTOR INFO:',2(/'#'))  
...
end subroutine dx_reciprocal_lvec
