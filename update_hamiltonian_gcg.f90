subroutine update_hamiltonian_gcg(kp, ham, ldawfn, len, neig, wfn, &
     pot_gspace, bands, crys, energs, pw_params, denc, rden, den, vion, &
     vbareion,iter,vin,time,t3)
  !
  !     1996 Bernd Pfrommer
  !
  ...
  !
  complex(dp) :: cdtot  
  integer :: n, i, ntot, ids, irk, iscfconv, iwfn,rlen, nfn, is ,nspin  
  ...
  return  
  !
end subroutine update_hamiltonian_gcg
